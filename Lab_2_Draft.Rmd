...
covid_data$mask_mandate <- 
  ifelse(covid_data$`Mandate face mask use by employees in public-facing businesses.y`
         == 0, FALSE, TRUE)
covid_data %>% 
...
covid_data$mask_mandate_public <- 
  ifelse(covid_data$`Mandate face mask use by all individuals in public spaces.y` == 0,
         FALSE, TRUE)
covid_data %>% 
