...
covid_data_renamed$mobility_population_dens <- covid_data_renamed$population_density*covid_data_renamed$retail_mobility_change

ggplot(covid_data_renamed, aes(x = mobility_population_dens , y = death_rate)) +
  geom_point() +
  geom_smooth(se = FALSE) +
  labs(title = "Deaths by Stay at home length", x = "Stay at home length", y = "Death rate per 100K")
```
