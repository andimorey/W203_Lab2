...
```{r}
ggplot(covid_data_renamed, aes(x = log(population_density), y = death_rate)) +geom_point()+
...
```{r}
ggplot(covid_data_renamed, aes(x = mask_mandate_rank, y = death_in_last_7)) +
  geom_point() +
  geom_smooth(se = FALSE) +
...
```{r}
ggplot(covid_data_renamed, aes(x = mask_enforced_by_fines+mask_enforced_by_charge , y = death_rate)) +
  geom_point() +
  geom_smooth(se = FALSE) +
...
```{r}
ggplot(covid_data_renamed, aes(x = log(mobility_population_dens) , y = death_rate)) +
  geom_point() +
  geom_smooth(se = FALSE) +
...
```{r}
ggplot(covid_data_renamed, aes(x = all_mobility_changes , y = death_rate)) +
  geom_point() +
  geom_smooth(se = FALSE) +
  labs(title = "Deaths by Stay at home length", x = "All Mobility Changes", y = "Death rate per 100K")
```

```{r}
ggplot(covid_data_renamed, aes(x = mobility_with_mask , y = death_rate)) +
  geom_point() +
  geom_smooth(se = FALSE) +
