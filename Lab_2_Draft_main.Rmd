...
plot1_var2 = plot_usmap(data = covid_data, values = "percent_over_65") +
        scale_fill_continuous(low = "white", high = "blue", name = "Proportion", label = scales::comma) +
