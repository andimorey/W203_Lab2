...
We will use white population percentage as our additional variable in model 2 because: 
1. We see variance in it over states so a change in it could indicate differences in our outcome variable
2. There seems to be some relationship between it and the outcome variable
